      ...
      <div className="max-w-[1600px] mx-auto border-x border-border">
        ...
        <div className="p-8 lg:p-24 min-h-[70vh] flex items-center justify-center">
          <div className="max-w-4xl mx-auto">
            <h3 className="text-4xl md:text-6xl font-bold tracking-tight text-white mb-10 text-center">
              About
            </h3>
            <p className="text-zinc-300 text-lg md:text-2xl leading-relaxed font-light text-center">
            ...
            <p className="text-zinc-400 text-base md:text-lg leading-relaxed font-mono mt-10 text-center">
