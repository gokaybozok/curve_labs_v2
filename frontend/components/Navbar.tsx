    ...
    <nav className="sticky top-0 z-50 bg-background/80 backdrop-blur-md">
      <div className="max-w-[1600px] mx-auto px-6 h-20 flex items-center justify-between">
        ...
        <div className="hidden md:flex gap-10">
          ...
          <a href="#lace" onClick={handleNavClick('lace')} className="font-mono text-sm text-zinc-400 hover:text-white transition-colors">
            [02] LACE
          </a>
          <a href="#about" onClick={handleNavClick('about')} className="font-mono text-sm text-zinc-400 hover:text-white transition-colors">
            [03] ABOUT
          </a>
          <a href="#team" onClick={handleNavClick('team')} className="font-mono text-sm text-zinc-400 hover:text-white transition-colors">
            [04] TEAM
          </a>
        </div>
