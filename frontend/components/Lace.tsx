      ...
      <div className="w-full relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2">
          ...
          <div className="p-0 lg:p-24 flex flex-col justify-between min-h-[600px] relative overflow-hidden">
            ...
            <div
              className={`absolute inset-0 bg-gradient-to-r from-black/25 via-black/10 to-transparent transition-opacity duration-[2200ms] ease-out ${
                fadeOverlayOut ? 'opacity-0' : 'opacity-100'
              }`}
            />
            {/* Background Pattern */}
            <div
