          ...
          <div className="p-8 lg:p-24 flex flex-col justify-between min-h-[600px] relative overflow-hidden">
            ...
            <div className="relative z-10 mt-12">
              <a
                ...
                className="inline-flex items-center gap-3 text-base md:text-lg font-nav text-white hover:text-zinc-300 transition-colors border-b border-white hover:border-zinc-300 pb-1"
              >
                EXPLORE LACE →
              </a>
            </div>
